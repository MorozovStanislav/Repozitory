...
Для данного проекта была выбрана тема информационная система "Обувного магазина". Цель информационной системы: повышение оперативности и качества процесса отслеживания купли-продажи обуви. Практическая работа выполнена на языке C#. C# — это объектно и компонентно-ориентированный язык программирования. C# предоставляет языковые конструкции для непосредственной поддержки такой концепции работы. Благодаря этому C# подходит для создания и применения программных компонентов.[<sup>[1]</sup>](#resourse_1)
...
Индивидуальный пошив мужской и женской обуви любых размеров, по вашим меркам.[<sup>[2]</sup>](#resourse_2)
...
Существует множество сервисов, которые помогают решить такие задачи как: работа с клиентами, продажа товаров и услуг, расчёт и выдача чека. Для рассмотрения сущесвующих решений можно взять облачный сервис "Антисклад", который  создан для управленческого учета как одного розничного магазина, так и розничной сети, а также он способен интегрироваться с различными интернет-платформами. Из его возможностей можно выделить основные: 
- реализация необходимых бизнес-процессов торгового предприятия, состоящего из одного или нескольких магазинов, таких как: закупки от поставщиков, движение товара, продажи, ценообразование, печать всех необходимых сопроводительных документов;
- формирование документов - на всем протяжении бизнес-процесса «Антисклад» снабжает Вас всеми необходимыми документами: накладные, спецификации, товарные чеки, бумажные отчеты, товарные этикетки и др;
- скидки, переоценки и печать ценников. В «Антисклад» предусмотрены гибкие механизмы управления ценообразованием и печать красивых этикеток с розничными ценами. Вы сможете проводить промоакции и назначать автоматические скидки;
Не смотря на всё выше перечисленное, этот сервис может не подойти тем, кто использует единицы измерения кроме штук, например, весовой товар; тем, кто работает с составными товарами например: букеты, напитки, подарочные наборы, готовые блюда и др.; и тем кто использует 3 и более модификаций товаров, например, у одежды всего два модификатора, это рост и размер, а вот у папиросы их много (длина, толщина, плотность и др.).[<sup>[3]</sup>](#resourse_3)
<br/> Для примера можно взять ещё один сервис под названием "МойСклад". Из его основных возможностей можно выделить такие:
- складской учет - приемки, отгрузки, инвентаризации. Работа с размерами, цветами, упаковками, серийными номерами, весовым товаром;
- сборка и производство - оформление операции по сборке и разборке, контролироль движения комплектующих, счёт себестоимости и планирование потребностей в материалах;
- обработка заказов - получение уведомления о новых заказах, назначение менеджеров, смена статусы, создание отгрузок. Также можно легко сверять комплектацию при сборе заказов на складе;
- управление финансами - контролироль взаиморасчетов с клиентами. Получение выписки из любого банка, отправка и печать платежных поручений;
- работа с клиентами - сбор информации о клиенте в личную карточку.[<sup>[3]</sup>](#resourse_4)
...
<br/> Листинг 1 - Класс "Дизайн-проекта"
```csharp
...
<br/> Листинг 3 - Контролёр для класса "Дизайн-проект"
```csharp
...
<br/> Листинг 4 - Репозиторий для класса "Дизайн-проект"
```csharp
...
В рамках данной работы была разработана информационная система для более быстрого и простого обслуживания клиентов, а также для управления материалами по пошиву обуви. Для этого, в первую очередь, были определены внешние системы, влияющие на решение, а также системы, учитываемые при формировании допустимых решений; цели, требования, условия, далее была проведена проверка полноты и достоверности исходных данных.

Разработав и протестировав систему, был получен опыт работы с информационной системой и достигут успешный результат, но в дальнейшем планируется более глубокое развитие проекта, привязка его к базе данных, добавление новых функций и методов для расширения возможностей системы.
...
[1] Краткий обзор языка C# [электронный ресурс] // Режим доступа: https://docs.microsoft.com/ru-ru/dotnet/csharp/tour-of-csharp/ , свободный (дата обращения 15.12.2021).
   
<a name="resourse_2">
   
[2] Виды обувных мастерских и их продукции [электронный ресурс] // "ОБУВНАЯ МАСТЕРСКАЯ" - Режим доступа: https://www.lelab.ru/support/19.html , свободный (дата обращения 02.12.2021).
   
<a name="resourse_3">
   
[3] Сервис "Антисклад" [электронный ресурс] // Режим доступа: https://wiki.antisklad.ru/manual/introduction , свободный (дата обращения 19.12.2021).
   
<a name="resourse_4">
   
[4] Сервис "МойСклад" [электронный ресурс] // Режим доступа: https://www.moysklad.ru/vozmozhnosti/ , свободный (дата обращения 19.12.2021).
