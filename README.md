...
Для примера можно взять ещё один сервис под названием "МойСклад". Из его основных возможностей можно выделить такие:
- складской учет - приемки, отгрузки, инвентаризации. Работа с размерами, цветами, упаковками, серийными номерами, весовым товаром. Печать документов и аналитика;
