...
В рамках данной работы была разработана информационная система для более быстрого и простого обслуживания клиентов, а также для управления материалами для пошива обуви. Для этого, в первую очередь, были определены все сущности, участвующие в заданной предметной области, связи между ними, процессы обмена информацией, а также требования и задачи к системе.
